...
@rounded
Scenario Outline: Matches sum(s) from given datasets with units digit position
 Given the arrays to match are parsed from "<fst>" and "<snd>"
...
Scenario Outline: Matches sum(s) from given datasets with units digit position
 Given the arrays to match are parsed from "<fst>" and "<snd>"
  ...
  Examples:
    ...
    | [10, 21, 54]                   | [65, 48]                       | 1   | [[10, 54], [65]]       |
    | [120, 240, 1321]               | [30, 1501]                     | 2   | [[240, 1321], [1501]]  |
    | [120, 240, 1321]               | [1005, 1208]                   | 2   | []                     |
    | [1800, 2105, 3505, 20, 30, 40] | [302, 611, 466, 5123, 295 ]    | 3   | [[2105, 3505], [5123]] |
